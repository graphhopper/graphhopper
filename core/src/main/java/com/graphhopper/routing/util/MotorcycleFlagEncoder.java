...
import com.graphhopper.routing.ev.SignedDecimalEncodedValue;
...
public class MotorcycleFlagEncoder extends CarFlagEncoder {
    ...
    public void createEncodedValues(List<EncodedValue> registerNewEncodedValue, String prefix) {
        ...
        registerNewEncodedValue.add(priorityWayEncoder = new SignedDecimalEncodedValue(getKey(prefix, "priority"), 4, PriorityCode.getFactor(1), false));
        registerNewEncodedValue.add(curvatureEncoder = new SignedDecimalEncodedValue(getKey(prefix, "curvature"), 4, 0.1, false));
    }
