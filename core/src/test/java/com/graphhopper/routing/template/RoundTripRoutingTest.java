...
public class RoundTripRoutingTest {
    ...
    public void testLookupAndCalcPaths_simpleSquareGraph() {
        ...
        List<Path> paths = RoundTripRouting.calcPaths(stagePoints, new PathCalculatorWithAvoidedEdges(new PathCalculator(queryGraph,
    ...
    public void testCalcRoundTrip() {
        ...
        PathCalculatorWithAvoidedEdges pathCalculator = new PathCalculatorWithAvoidedEdges(new PathCalculator(
        ...
        pathCalculator = new PathCalculatorWithAvoidedEdges(new PathCalculator(
                qGraph, new RoutingAlgorithmFactorySimple(), new AlgorithmOptions(DIJKSTRA_BI, fastestWeighting, tMode)));
