 ...
 * @author Thomas Butz
 */
public class PortugalSpatialRule extends DefaultSpatialRule {

    @Override
    public double getMaxSpeed(String highwayTag, double _default) {
        // https://en.wikipedia.org/wiki/Speed_limits_in_Portugal
        switch (highwayTag) {
        case "motorway":
            return 120;
        case "trunk":
    ...
    public Toll getToll(String highwayTag, Toll _default) {
        // https://en.wikipedia.org/wiki/Roads_in_Portugal#Tolls_and_taxation
