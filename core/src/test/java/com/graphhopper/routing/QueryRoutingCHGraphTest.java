...
//        assertNodesConnected(queryCHGraph, 0, 2, false);
    ...
    public void getWeight_withAccess() {
        ...
        assertEquals(428.84832, iter.getWeight(true), 1.e-4);
        assertEnd(iter);

        // single edges
        assertEquals(428.84832, routingCHGraph.getEdgeIteratorState(0, 1).getWeight(false), 1.e-4);
        ...
        assertEquals(428.84832, routingCHGraph.getEdgeIteratorState(0, 0).getWeight(true), 1.e-4);
        ...
        assertEquals(Double.POSITIVE_INFINITY, iter.getWeight(false));
        assertEquals(214.4242, iter.getWeight(true), 1.e-4);
        assertEnd(iter);
        ...
        assertEquals(214.4242, iter.getWeight(false), 1.e-4);
        assertEquals(Double.POSITIVE_INFINITY, iter.getWeight(true));
        assertEnd(iter);
