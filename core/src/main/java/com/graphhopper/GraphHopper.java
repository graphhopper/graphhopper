...
public class GraphHopper {
    ...
    protected void importOSM() {
        ...
        CustomArea area = GHUtility.getFirstDuplicateArea(customAreas, Country.JSON_AREA3);
        if (area != null)
            throw new IllegalArgumentException("area used duplicate '" + Country.JSON_AREA3 + "' see properties: " + area.getProperties());
