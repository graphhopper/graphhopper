 ...
 * @author Peter Karich
 */
public class Car4WDFlagEncoderTest {
    ...
    public void testTurnFlagEncoding_noCosts() {
        FlagEncoder tmpEnc = new Car4WDFlagEncoder(8, 5, 0);
    ...
    public void testTurnFlagEncoding_withCosts() {
        FlagEncoder tmpEncoder = new Car4WDFlagEncoder(8, 5, 127);
    ...
    public void testMaxValue() {
        Car4WDFlagEncoder instance = new Car4WDFlagEncoder(10, 0.5, 0);
