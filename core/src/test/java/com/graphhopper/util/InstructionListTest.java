...
public class InstructionListTest
{
    ...
    public void testCreateGPX()
    {
        ...
        distances.add(100);
        distances.add(10);
        instructions.add(new Instruction(Instruction.CONTINUE_ON_STREET, "temp", 0,0, distances, times, pl));
        ...
        pl = new PointList();
        pl.add(51.272226, 13.623047);
        instructions.add(new Instruction(Instruction.TURN_LEFT, "temp2", 0,0, distances, times, pl));
