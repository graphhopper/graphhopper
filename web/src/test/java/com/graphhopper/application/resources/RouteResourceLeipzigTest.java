...
public class RouteResourceLeipzigTest {
    ...
    @CsvSource(value = {
            ...
            "109,-1,algorithm=" + ASTAR_BI,
            "30736,1,ch.disable=true&algorithm=" + DIJKSTRA,
            "21127,1,ch.disable=true&algorithm=" + ASTAR,
            "14828,1,ch.disable=true&algorithm=" + DIJKSTRA_BI,
