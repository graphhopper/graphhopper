...
public class OSMReaderTest
{
    ...
    public void testReadEleFromDataProvider()
    {
        ...
        assertEquals(Helper.createPointList3D(49.5001, 11.501, 410, 49.5002, 11.5015, 410, 49.5011, 11.502, 377.0),
                edge.fetchWayGeometry(3));

        edge = GHUtility.getEdge(graph, n10, n50);
        assertEquals(Helper.createPointList3D(49.501, 11.5001, 371.0, 49.5001, 11.501, 410.0),
                edge.fetchWayGeometry(3));
    }
}
