...
public class RouteResourceLeipzigTest {
    ...
    @ParameterizedTest
    @CsvSource(value = {
            "106,-1,algorithm=" + DIJKSTRA_BI,
            "117,-1,algorithm=" + ASTAR_BI,
            "30727,1,ch.disable=true&algorithm=" + DIJKSTRA,
            "21019,1,ch.disable=true&algorithm=" + ASTAR,
            "14722,1,ch.disable=true&algorithm=" + DIJKSTRA_BI,
            "10396,1,ch.disable=true&algorithm=" + ASTAR_BI
    })
