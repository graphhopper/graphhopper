...
public class GraphHopper implements GraphHopperAPI
{
    ...
    protected void initCHPrepare()
    {
        ...
        PrepareContractionHierarchies tmpPrepareCH = new PrepareContractionHierarchies(encoder, createWeighting(chWeighting, encoder));
        tmpPrepareCH.setPeriodicUpdates(periodicUpdates).setLazyUpdates(lazyUpdates).setNeighborUpdates(neighborUpdates);
