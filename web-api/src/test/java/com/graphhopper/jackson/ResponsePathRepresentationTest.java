...
public class ResponsePathRepresentationTest {
    ...
    public void testDecode() {
        PointList list = ResponsePathDeserializerHelper.decodePolyline("_p~iF~ps|U", 1, false, 1e5);
        assertEquals(Helper.createPointList(38.5, -120.2), list);

        list = ResponsePathDeserializerHelper.decodePolyline("_p~iF~ps|U_ulLnnqC_mqNvxq`@", 3, false, 1e5);
    ...
    public void testBoth() {
        ...
        assertEquals(list, ResponsePathDeserializerHelper.decodePolyline(str, list.size(), false, 1e5));
    ...
    public void testDecode3D() {
        PointList list = ResponsePathDeserializerHelper.decodePolyline("_p~iF~ps|Uo}@", 1, true, 1e5);
        assertEquals(Helper.createPointList3D(38.5, -120.2, 10), list);

        list = ResponsePathDeserializerHelper.decodePolyline("_p~iF~ps|Uo}@_ulLnnqC_anF_mqNvxq`@?", 3, true, 1e5);
