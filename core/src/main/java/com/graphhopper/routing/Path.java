...
public class Path
{
    ...
    {
        if (revert && !encoder.isBool(flags, FlagEncoder.BACKWARD)
                || !revert && !encoder.isBool(flags, FlagEncoder.FORWARD))
            throw new IllegalStateException("Calculating time should not require to read speed from edge in wrong direction. "
                    + "Reverse:" + revert + ", fwd:" + encoder.isBool(flags, FlagEncoder.FORWARD) + ", bwd:" + encoder.isBool(flags, FlagEncoder.BACKWARD));
