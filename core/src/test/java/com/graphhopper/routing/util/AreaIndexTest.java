...
class AreaIndexTest {
    ...
    public void testCountries() {
        ...
        assertEquals("DE", countryIndex.query(52.52437, 13.41053).get(0).getProperties().get(Country.ISO_3166_2));
        assertEquals("FR", countryIndex.query(48.86471, 2.349014).get(0).getProperties().get(Country.ISO_3166_2));
        assertEquals("US-NM", countryIndex.query(35.67514, -105.94665).get(0).getProperties().get(Country.ISO_3166_2));
        assertEquals("AT", countryIndex.query(48.20448, 16.10788).get(0).getProperties().get(Country.ISO_3166_2));
    }
