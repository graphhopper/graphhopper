...
public class CHPreparationGraph {
    ...
    // prepare edge IDs range from edges to Integer.MAX_VALUE and continue from there to Integer.MIN_VALUE and up to (excluding) -1.
    // todo: it's a bit strange we do not start from 0 and count up in addEdge automatically?
    ...
    public int addShortcut(int from, int to, int origEdgeKeyFirst, int origEdgeKeyLast, int skipped1,
        ...
        if (Integer.toUnsignedLong(nextPrepareEdge) == MAX_PREPARE_EDGE_COUNT)
