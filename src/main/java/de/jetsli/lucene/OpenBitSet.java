 ...
 * <code>java.util.BitSet</code> in most operations and *much* faster at calculating cardinality of
 * sets and results of set operations. It can also handle sets of larger cardinality (up to 64 *
 * 2**32-1)
 * <p/>
 * The goals of
