...
public class GraphHopperStorageForDataFlagEncoderTest {
    ...
    public void testStorageProperties() {
        ...
        graph.getEdgeIteratorState(0, 1).setFlags(encoder.handleWayTags(new IntsRef(), way_0_1, 1, 0));
        ...
        graph.getEdgeIteratorState(1, 2).setFlags(encoder.handleWayTags(new IntsRef(), way_1_2, 1, 0));
        ...
        graph.getEdgeIteratorState(2, 0).setFlags(encoder.handleWayTags(new IntsRef(), way_2_0, 1, 0));
