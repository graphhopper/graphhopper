...
public class DouglasPeuckerTest {
    ...
    public void testParse() {
        ...
        assertEquals(49.945605917549265, g.getLatitude(0), 1e-6);
        assertEquals(11.571499218899739, g.getLongitude(0), 1e-6);
        assertEquals(49.94570668665409, g.getLatitude(1), 1e-6);
        assertEquals(11.571664621792689, g.getLongitude(1), 1e-6);
    }
...
//        System.out.println(str);
        ...
        // .5m
        assertEquals("{0, -1, 2, -1, 4, 5, 6, 7, -1, -1, 10, -1, 12, 13, -1, 15, 16, 17, "
                + "18, -1, 20, -1, 22, -1, -1, 25, 26, 27, -1, 29, -1, 31}", points.toString());
        // 20m
