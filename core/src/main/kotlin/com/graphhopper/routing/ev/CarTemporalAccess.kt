...
enum class CarTemporalAccess {
    ...
    companion object {
        ...
        const val KEY = "car_temporal_access"

        @JvmStatic
        fun create(): EnumEncodedValue<CarTemporalAccess> =
            EnumEncodedValue(KEY, CarTemporalAccess::class.java)
    }
}
