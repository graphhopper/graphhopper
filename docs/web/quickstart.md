...
The following steps are simpler and only need the JRE, a jar file and an OSM file.
 ...
 1. Install the latest JRE and get GraphHopper Server as [zip](https://oss.sonatype.org/content/groups/public/com/graphhopper/graphhopper-web/0.8.0/graphhopper-web-0.8.0-bin.zip) (~9MB)
