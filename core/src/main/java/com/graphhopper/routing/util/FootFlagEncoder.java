...
public class FootFlagEncoder extends AbstractFlagEncoder {
    ...
    public void createEncodedValues(List<EncodedValue> registerNewEncodedValue, String prefix) {
        ...
        registerNewEncodedValue.add(avgSpeedEnc = new SignedDecimalEncodedValue(getKey(prefix, "average_speed"), speedBits, speedFactor, speedTwoDirections));
        registerNewEncodedValue.add(priorityWayEncoder = new SignedDecimalEncodedValue(getKey(prefix, "priority"), 4, PriorityCode.getFactor(1), speedTwoDirections));
