...
public class QueryGraphTest {
    ...
    void initGraph(Graph g, BooleanEncodedValue accessEnc, DecimalEncodedValue averageSpeedEnc) {
        //
        //  /*-*\
        // 0     1
        // |
        ...
        na.setNode(1, 1, 2.5);
        na.setNode(2, 0, 0);
        GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, 0, 2, true, 10);
        GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, 0, 1, true, 10).setWayGeometry(Helper.createPointList(1.5, 1, 1.5, 1.5));
    }

    @Test
    public void testOneVirtualNode() {
        initGraph(g, accessEnc, averageSpeedEnc);
    ...
    public void testOneWay() {
        ...
        na.setNode(0, 0, 0);
        na.setNode(1, 0, 1);
        GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, 0, 1, false, 10);
    ...
    public void testLoopStreet_Issue151() {
        ...
        //    x---
        //
        GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, 0, 1, true, 10);
        GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, 1, 3, true, 10);
        GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, 3, 4, true, 10);
        EdgeIteratorState edge = GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, 1, 3, true, 20).
    ...
    public void testOneWayLoop_Issue162() {
        ...
        EdgeIteratorState edge = GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, 0, 0, false, 100d).
    ...
    public void testIteration_Issue163() {
        ...
        GHUtility.createEdge(g, averageSpeedEnc, 60, accessEnc, nodeA, nodeB, false, 10).setWayGeometry(Helper.createPointList(1.5, 3, 1.5, 7));
    ...
    public void testTurnCostsProperlyPropagated_Issue282() {
        ...
        DecimalEncodedValue tmpAverageSpeedEnc = em.getDecimalEncodedValue(TagParserFactory.Car.AVERAGE_SPEED);
        ...
        EdgeIteratorState edge0 = GHUtility.createEdge(graphWithTurnCosts, tmpAverageSpeedEnc, 60, tmpAccessEnc, 0, 1, true, 10);
        EdgeIteratorState edge1 = GHUtility.createEdge(graphWithTurnCosts, tmpAverageSpeedEnc, 60, tmpAccessEnc, 2, 1, true, 10);
    ...
    private void initHorseshoeGraph(Graph g, BooleanEncodedValue tmpAccessEnc, DecimalEncodedValue tmpAverageSpeedEnc) {
        // setup graph
        //   ____
        //  |    |
        //  |    |
        ...
        na.setNode(0, 0, 0);
        na.setNode(1, 0, 2);
        GHUtility.createEdge(g, tmpAverageSpeedEnc, 60, tmpAccessEnc, 0, 1, true, 10).setWayGeometry(Helper.createPointList(2, 0, 2, 2));
    }
    ...
    public void testEnforceHeading() {
        initHorseshoeGraph(g, accessEnc, averageSpeedEnc);
        EdgeIteratorState edge = GHUtility.getEdge(g, 0, 1);
