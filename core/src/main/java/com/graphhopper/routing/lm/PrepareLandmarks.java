...
public class PrepareLandmarks extends AbstractAlgoPreparation {
    ...
    public RoutingAlgorithm getDecoratedAlgorithm(Graph qGraph, RoutingAlgorithm algo, AlgorithmOptions opts) {
        ...
        if (algo instanceof AStar) {
            ...
            astar.setApproximation(new LMApproximator(qGraph, this.graph.getNodes(), lms, activeLM, false).
                    setEpsilon(epsilon));
            return algo;
            ...
            astarbi.setApproximation(new LMApproximator(qGraph, this.graph.getNodes(), lms, activeLM, false).
                    setEpsilon(epsilon));
            return algo;
            ...
            altRoute.setApproximation(new LMApproximator(qGraph, this.graph.getNodes(), lms, activeLM, false).
                    setEpsilon(epsilon));
