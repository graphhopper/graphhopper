...
public class PrepareRoutingSubnetworksTest {
    ...
    public void testPrepareSubnetworks_twoVehicles() {
        ...
        GHUtility.setSpeed(10, false, false, carEncoder.getAccessEnc(), carEncoder.getAverageSpeedEnc(), edge);
        GHUtility.setSpeed(5, true, true, bikeEncoder.getAccessEnc(), bikeEncoder.getAverageSpeedEnc(), edge);
        ...
        GHUtility.setSpeed(10, false, false, carEncoder.getAccessEnc(), carEncoder.getAverageSpeedEnc(), edge);
        GHUtility.setSpeed(5, false, false, bikeEncoder.getAccessEnc(), bikeEncoder.getAverageSpeedEnc(), edge);
