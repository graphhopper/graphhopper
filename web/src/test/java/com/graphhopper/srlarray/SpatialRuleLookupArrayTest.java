...
public class SpatialRuleLookupArrayTest {
    ...
    public void testSpatialLookup() {
        ...
        SpatialRule germany = new GermanySpatialRule().addBorder(new Polygon(new double[]{1, 1, 2, 2}, new double[]{1, 2, 2, 1}));
        spatialRules.add(germany);
        SpatialRule austria = new AustriaSpatialRule().addBorder(new Polygon(new double[]{5, 5, 6, 6}, new double[]{5, 6, 6, 5}));
    ...
    public void testExactCountry() {
        ...
        spatialRules.add(new GermanySpatialRule().addBorder(germanPolygon));
        SpatialRuleLookup spatialRuleLookup = new SpatialRuleLookupArray(spatialRules, .1, true);
