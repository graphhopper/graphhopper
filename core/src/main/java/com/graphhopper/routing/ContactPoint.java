...
/**
 * This class stores a node at which both search spaces meat each other. It's stored together with its two
...
class ContactPoint {
    ...
    protected ContactPoint(SPTEntry entryFrom, SPTEntry entryTo) {
    ...
    protected SPTEntry getEntryFrom() {
        return entryFrom;
    }

    protected SPTEntry getEntryTo() {
        return entryTo;
    }
}
