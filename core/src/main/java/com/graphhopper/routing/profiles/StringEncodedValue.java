...
public final class StringEncodedValue extends IntEncodedValue {
    ...
    public StringEncodedValue(String name, List<String> values, String defaultValue) {
        ...
        // we could use an array, sort it and do binary search but this means breaking backward compatibility for every small change instead of just appending new tags
