...
enum class FootTemporalAccess {
    ...
    companion object {
        ...
        const val KEY = "foot_temporal_access"

        @JvmStatic
        fun create(): EnumEncodedValue<FootTemporalAccess> =
            EnumEncodedValue(KEY, FootTemporalAccess::class.java)
    }
}
