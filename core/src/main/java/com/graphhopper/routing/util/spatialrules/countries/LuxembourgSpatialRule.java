 ...
 * @author Thomas Butz
 */
public class LuxembourgSpatialRule extends DefaultSpatialRule {

    @Override
    public double getMaxSpeed(String highwayTag, double _default) {
        // As defined in: https://wiki.openstreetmap.org/wiki/OSM_tags_for_routing/Maxspeed#Luxembourg
        switch (highwayTag) {
            case "motorway":
                return 130;
            case "trunk":
