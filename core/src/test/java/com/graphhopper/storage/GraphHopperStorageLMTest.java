...
public class GraphHopperStorageLMTest {
    ...
    public void testLoad() {
        ...
        graph.getEdgeIteratorState(0, 1).setFlags(carFlagEncoder.handleWayTags(new IntsRef(), way_0_1, 1, 0));
        ...
        graph.getEdgeIteratorState(1, 2).setFlags(carFlagEncoder.handleWayTags(new IntsRef(), way_1_2, 1, 0));
