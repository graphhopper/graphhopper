...
public class GHPublicTransitTest
{
    ...
    private static final String testGTFS = "./src/test/resources/com/graphhopper/reader/test-gtfs2.zip";
    ...
    public void testLoadGTFS() throws IOException
    {
        ...
        GHRequest request = new GHRequest(36.905697, -116.76218, startTime, 36.914944, -116.761472);
    ...
    public void TestRoute()
    {
        ...
        request = new GHRequest(36.905697, -116.76218, startTime, 36.915682, -116.751677);
        request.setVehicle("PUBLIC");
