...
public class SmartWitnessPathFinderTest {
    ...
    public void test_shortcut_needed_basic() {
        ...
        SmartWitnessPathFinder finder = createFinder();
        finder.init(2, 1, 0);
    ...
    private ArraySmartWitnessPathFinder createFinder() {
        return new ArraySmartWitnessPathFinder(graph, chGraph, chTurnWeighting);
    }
