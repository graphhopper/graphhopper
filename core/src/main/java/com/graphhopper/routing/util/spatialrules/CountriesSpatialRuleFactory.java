...
import com.graphhopper.routing.util.spatialrules.countries.BosniaHerzegovinaSpatialRule;
import com.graphhopper.routing.util.spatialrules.countries.BulgariaSpatialRule;
...
import com.graphhopper.routing.util.spatialrules.countries.RomaniaSpatialRule;
import com.graphhopper.routing.util.spatialrules.countries.SanMarinoSpatialRule;
import com.graphhopper.routing.util.spatialrules.countries.SerbiaSpatialRule;
...
public class CountriesSpatialRuleFactory implements SpatialRuleLookupBuilder.SpatialRuleFactory {
    ...
    public SpatialRule createSpatialRule(String id, List<Polygon> polygons) {
        switch (id) {
            ...
            case "BGR":
                BulgariaSpatialRule bulgariaSpatialRule = new BulgariaSpatialRule();
                bulgariaSpatialRule.setBorders(polygons);
                return bulgariaSpatialRule;
            case "BIH":
                BosniaHerzegovinaSpatialRule bosniaHerzegovinaSpatialRule = new BosniaHerzegovinaSpatialRule();
                bosniaHerzegovinaSpatialRule.setBorders(polygons);
                return bosniaHerzegovinaSpatialRule;
            case "CHE":
            ...
            case "ROU":
                RomaniaSpatialRule romaniaSpatialRule = new RomaniaSpatialRule();
                romaniaSpatialRule.setBorders(polygons);
                return romaniaSpatialRule;
            case "SMR":
            ...
            case "SRB":
                SerbiaSpatialRule serbiaSpatialRule = new SerbiaSpatialRule();
                serbiaSpatialRule.setBorders(polygons);
                return serbiaSpatialRule;
            case "SVK":
