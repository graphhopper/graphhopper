...
public final class BooleanEncodedValueImpl extends IntEncodedValueImpl implements BooleanEncodedValue {

    private BooleanEncodedValueImpl() {
    }

    public BooleanEncodedValueImpl(String name) {
        this(name, false);
    }

    public BooleanEncodedValueImpl(String name, boolean storeBothDirections) {
