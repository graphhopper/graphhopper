...
object MaxSpeed {
     ...
     */
    const val MAXSPEED_150 = 150.0

    /**
     * The speed value used for road sections without known speed limit.
     */
    const val MAXSPEED_MISSING = Double.POSITIVE_INFINITY
    ...
    fun create(): DecimalEncodedValue =
        ...
        DecimalEncodedValueImpl(KEY, 7, 0.0, 2.0, false, true, true)
}
