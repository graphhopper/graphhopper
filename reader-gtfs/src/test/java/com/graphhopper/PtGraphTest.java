...
public class PtGraphTest {
    ...
    public void testEdge() {
        ...
        int edge1 = ptGraph.createEdge(12, 23, new PtEdgeAttributes(GtfsStorage.EdgeType.ENTER_PT, 123, null, 7, null, 1, -1, null));
        int edge2 = ptGraph.createEdge(23, 5, new PtEdgeAttributes(GtfsStorage.EdgeType.ENTER_PT, 123, null, 7, null, 1, -1, null));
        int edge3 = ptGraph.createEdge(7, 23, new PtEdgeAttributes(GtfsStorage.EdgeType.ENTER_PT, 123, null, 7, null, 1, -1, null));
