#!/bin/bash
# usage:
# benchmark/benchmark.sh <data_dir> <results_dir> <small_osm_map_path> <big_osm_map_path> <use_measurement_time_as_ref_time> <area_borders_directory>
#
# where:
...
# <area_borders_directory> = base directory to load areas for the area index test from
...
defaultAreasDirectory=core/files/spatialrules
...
BORDERS_DIRECTORY=${6:-$defaultAreasDirectory}
...
area_borders_directory=${BORDERS_DIRECTORY} \
