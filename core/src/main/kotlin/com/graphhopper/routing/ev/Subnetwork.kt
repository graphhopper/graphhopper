...
object Subnetwork {
    ...
    fun key(prefix: String): String {
        if (prefix.contains("subnetwork"))
            throw IllegalArgumentException("Cannot create key containing 'subnetwork' in prefix: $prefix")
        return prefix + "_subnetwork"
    }

    @JvmStatic
    fun create(prefix: String): BooleanEncodedValue = SimpleBooleanEncodedValue(key(prefix))
}
