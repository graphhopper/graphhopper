    ...
    public void initialize(Bootstrap<TardurConfiguration> bootstrap) {
        ...
        bootstrap.addBundle(new ViewBundle() {
            ...
            public Map<String, Map<String, String>> getViewConfiguration(Configuration wurst) {
                return ((TardurConfiguration) wurst).getViewRendererConfiguration();
            }
        });
    }

    @Override
    public void run(TardurConfiguration configuration, Environment environment) {
        ...
        final TardurGraphHopperManaged graphHopperManaged = new TardurGraphHopperManaged(configuration.getGraphHopperConfiguration(), environment.getObjectMapper());
        ...
        environment.jersey().register(new AbstractBinder() {
            ...
            protected void configure() {
                ...
                bind(graphHopperManaged).to(TardurGraphHopperManaged.class);
