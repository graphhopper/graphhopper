...
public class GraphHopperIT {
    ...
    public void testAlternativeRoutesBikeAndCar() {
        GraphHopper tmpHopper = new GraphHopperOSM().
                ...
                setEncodingManager(new EncodingManager.Builder().addAllFlagEncoders("bike, car").build());
    ...
    public void testNorthBayreuthDestination() {
        GraphHopper tmpHopper = new GraphHopperOSM().
                ...
                setCHEnabled(false).
                setGraphHopperLocation(tmpGraphFile).
                setEncodingManager(new EncodingManager.Builder().addAll(FlagEncoderFactory.DEFAULT, "car,generic", 8).build());
        tmpHopper.importOrLoad();
    ...
    public void testNorthBayreuthBlockeEdges() {
        GraphHopper tmpHopper = new GraphHopperOSM().
                ...
                setCHEnabled(false).
                setGraphHopperLocation(tmpGraphFile).
                setEncodingManager(new EncodingManager.Builder().addAll(FlagEncoderFactory.DEFAULT, "generic,car", 8).build());
        tmpHopper.importOrLoad();
    ...
    public void testKremsCyclewayInstructionsWithWayTypeInfo() {
        ...
        GraphHopper tmpHopper = new GraphHopperOSM().
                ...
                setCHEnabled(false).
                setGraphHopperLocation(tmpGraphFile).
                setEncodingManager(new EncodingManager.Builder().addAllFlagEncoders(tmpImportVehicles).build()).
                importOrLoad();
    ...
    public void testMultipleVehiclesWithCH() {
        ...
        tmpHopper = new GraphHopperOSM().
                ...
                setStoreOnFlush(true).
                setGraphHopperLocation(tmpGraphFile).
                setEncodingManager(new EncodingManager.Builder().addAllFlagEncoders("car,bike").build()).
                importOrLoad();
    ...
    public void testTurnCostsOnOff() {
        GraphHopper tmpHopper = new GraphHopperOSM().
                ...
                setCHEnabled(false).
                setGraphHopperLocation(tmpGraphFile).
                setEncodingManager(new EncodingManager.Builder().addAllFlagEncoders("car|turn_costs=true").build());
        tmpHopper.importOrLoad();
