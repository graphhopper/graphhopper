...
public class GraphHopper {
    ...
    private DAType dataAccessDefaultType = DAType.NATIVE_STORE;
    ...
    public GraphHopper setStoreOnFlush(boolean storeOnFlush) {
        ensureNotLoaded();
        if (storeOnFlush)
            dataAccessDefaultType = DAType.NATIVE_STORE;
        else
            dataAccessDefaultType = DAType.NATIVE;
        return this;
    }
    ...
    public GraphHopper init(GraphHopperConfig ghConfig) {
        ...
        String daTypeString = ghConfig.getString("graph.dataaccess.default_type", ghConfig.getString("graph.dataaccess", "NATIVE_STORE"));
