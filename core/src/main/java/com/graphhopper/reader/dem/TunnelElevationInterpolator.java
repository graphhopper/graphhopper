...
public class TunnelElevationInterpolator extends AbstractEdgeElevationInterpolator {
    ...
    public TunnelElevationInterpolator(GraphHopperStorage storage, RoadEnvironmentParser roadEnvironmentParser) {
        super(storage, roadEnvironmentParser);
    }

    @Override
    protected boolean isInterpolatableEdge(EdgeIteratorState edge) {
        return roadEnvironmentParser.isTransportModeTunnel(edge);
    }
}
