...
/**
 * The mountain biking difficulty of an edge. See <a href="https://wiki.openstreetmap.org/wiki/Key:mtb:scale">Key:mtb:scale</a>
 * for details.
 */
public enum MtbScale {
    ...
    /**
     * Finds the {@link MtbScale} from a {@link String}. This method properly converts values such as '1+' or '2-',
    ...
    public static MtbScale find(String name) {
        ...
        try {
            ...
            if (name.length() == 2 && (name.charAt(1) == '+' || name.charAt(1) == '-'))
                return MtbScale.valueOf("MTB_" + name.charAt(0));
            return NONE;
