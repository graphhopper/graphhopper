 ...
 * [LocationIndex](../example/src/test/java/com/graphhopper/example/LocationIndexExampleTest.java): Code about how to get the location index for getting i.e. the nearest edge. 
