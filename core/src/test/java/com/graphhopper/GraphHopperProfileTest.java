...
public class GraphHopperProfileTest {
    ...
    public void duplicateProfileName_error() {
        ...
        assertIllegalArgument(() -> hopper.setProfiles(
                new CustomProfile("my_profile").setVehicle("car"),
                new CustomProfile("your_profile").setVehicle("car"),
                new CustomProfile("my_profile").setVehicle("car")
    ...
    public void vehicleDoesNotExist_error() {
        ...
        hopper.setGraphHopperLocation(GH_LOCATION).setStoreOnFlush(false).
                setProfiles(new CustomProfile("profile").setVehicle("your_car"));
    ...
    public void oneVehicleTwoProfilesWithAndWithoutTC_noError() {
        final GraphHopper hopper = createHopper();
        hopper.setProfiles(
                new CustomProfile("profile1").setVehicle("car").setTurnCosts(false),
                new CustomProfile("profile2").setVehicle("car").setTurnCosts(true));
        hopper.load();
    }
    ...
    public void profileWithUnknownWeighting_error() {
        final GraphHopper hopper = createHopper();
        hopper.setProfiles(new CustomProfile("profile").setVehicle("car").setWeighting("your_weighting"));
    ...
    public void chProfileDoesNotExist_error() {
        final GraphHopper hopper = createHopper();
        hopper.setProfiles(new CustomProfile("profile1").setVehicle("car"));
    ...
    public void duplicateCHProfile_error() {
        final GraphHopper hopper = createHopper();
        hopper.setProfiles(new CustomProfile("profile").setVehicle("car"));
    ...
    public void lmPreparationProfileChain_error() {
        final GraphHopper hopper = createHopper();
        hopper.setProfiles(
                new CustomProfile("profile1").setVehicle("car"),
                new CustomProfile("profile2").setVehicle("bike"),
                new CustomProfile("profile3").setVehicle("foot")
        );
        hopper.getLMPreparationHandler().setLMProfiles(
