...
class OSMSmoothnessParser(private val smoothnessEnc: EnumEncodedValue<Smoothness>) : TagParser {

    override fun handleWayTags(edgeId: Int, edgeIntAccess: EdgeIntAccess, way: ReaderWay, relationFlags: IntsRef?) {
        val smoothnessTag = way.getTag("smoothness")
        val smoothness = Smoothness.find(smoothnessTag)
