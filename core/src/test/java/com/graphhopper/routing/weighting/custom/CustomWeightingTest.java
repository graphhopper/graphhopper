...
class CustomWeightingTest {
    ...
    public void testMaxSpeed() {
        ...
        assertEquals(1000.0 / 72 * 3.6, createWeighting(new CustomModel().
                addToSpeed(If("true", LIMIT, "72")).setDistanceInfluence(0d)).calcMinWeight(1000));
        ...
        assertEquals(1000.0 / 155 * 3.6, createWeighting(new CustomModel().
                addToSpeed(If("true", LIMIT, "180")).setDistanceInfluence(0d)).calcMinWeight(1000));
        ...
        assertEquals(1000.0 / 150 * 3.6, createWeighting(new CustomModel().
                ...
                addToSpeed(If("true", LIMIT, "150")).setDistanceInfluence(0d)).calcMinWeight(1000));
    }
    ...
    public void testMaxPriority() {
        ...
        assertEquals(1000.0 / maxSpeed / 0.5 * 3.6, createWeighting(new CustomModel().
                addToPriority(If("true", MULTIPLY, "0.5")).setDistanceInfluence(0d)).calcMinWeight(1000), 1.e-6);

        // ignore too big limit
        assertEquals(1000.0 / maxSpeed / 1.0 * 3.6, createWeighting(new CustomModel().
                addToPriority(If("true", LIMIT, "2.0")).setDistanceInfluence(0d)).calcMinWeight(1000), 1.e-6);
        ...
        assertEquals(1000.0 / maxSpeed / 1.5 * 3.6, createWeighting(new CustomModel().
                addToPriority(If("true", MULTIPLY, "1.5")).setDistanceInfluence(0d)).calcMinWeight(1000), 1.e-6);
        ...
        assertEquals(1000.0 / maxSpeed / 3.0 * 3.6, createWeighting(new CustomModel().
                addToPriority(If("road_class == SERVICE", MULTIPLY, "3.0")).setDistanceInfluence(0d)).calcMinWeight(1000), 1.e-6);

        // do NOT pick maximum priority when it is for a special case
        assertEquals(1000.0 / maxSpeed / 1.0 * 3.6, createWeighting(new CustomModel().
                addToPriority(If("road_class == SERVICE", MULTIPLY, "0.5")).setDistanceInfluence(0d)).calcMinWeight(1000), 1.e-6);
    }
