...
public class CarFlagEncoder extends AbstractFlagEncoder {
    ...
    public void createEncodedValues(List<EncodedValue> registerNewEncodedValue, String prefix) {
        ...
        registerNewEncodedValue.add(avgSpeedEnc = new SignedDecimalEncodedValue(EncodingManager.getKey(prefix, "average_speed"), speedBits, speedFactor, speedTwoDirections));
    }
