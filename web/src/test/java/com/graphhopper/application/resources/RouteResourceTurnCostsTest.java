    ...
    private static GraphHopperServerConfiguration createConfig() {
        ...
        config.getGraphHopperConfiguration().
                ...
                .setProfiles(Arrays.asList(
                        new Profile("my_car_turn_costs").setTurnCostsConfig(new TurnCostsConfig("car")).setCustomModel(Helper.createBaseModel("car")),
                        new Profile("my_car_no_turn_costs").setCustomModel(Helper.createBaseModel("car")),
                        new Profile("my_custom_car_turn_costs").setTurnCostsConfig(new TurnCostsConfig("car")).setCustomModel(Helper.createBaseModel("car")),
