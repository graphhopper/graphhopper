...
public class LandmarkStorageTest {
    ...
    public void testWithSubnetworks() {
        ...
        LandmarkStorage storage = new LandmarkStorage(graph, encodingManager, new GHDirectory("", DAType.RAM_NOFILE), new LMConfig("car", weighting), 2);
    ...
    public void testWeightingConsistence1() {
        ...
        LandmarkStorage storage = new LandmarkStorage(graph, encodingManager, new GHDirectory("", DAType.RAM_NOFILE),
