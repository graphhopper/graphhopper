...
public abstract class AbstractGraphStorageTester {
    ...
    public void testCopyProperties() {
        ...
        assertEquals(edge.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY), newEdge.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY));
    }
    ...
    public void testSimpleDelete2() {
        ...
        assertEquals(2, iter.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY).getLongitude(0), 1e-7);
    ...
    public void testPillarNodes() {
        ...
        assertPList(Helper.createPointList(1, 11, 1, 12, 1, 13.0), iter.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY));
        assertPList(Helper.createPointList(0.01, 0.01, 1, 11, 1, 12, 1, 13.0), iter.fetchWayGeometry(FetchWayGeometry.BASE_AND_PILLAR));
        assertPList(Helper.createPointList(1, 11, 1, 12, 1, 13.0, 0.14, 0.14), iter.fetchWayGeometry(FetchWayGeometry.PILLAR_AND_ADJ));
        assertPList(Helper.createPointList(0.01, 0.01, 1, 11, 1, 12, 1, 13.0, 0.14, 0.14), iter.fetchWayGeometry(FetchWayGeometry.ALL));

        assertTrue(iter.next());
        assertEquals(4, iter.getAdjNode());
        assertPList(Helper.createPointList(1, 1, 1, 2, 1, 3), iter.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY));
        assertPList(Helper.createPointList(0.01, 0.01, 1, 1, 1, 2, 1, 3), iter.fetchWayGeometry(FetchWayGeometry.BASE_AND_PILLAR));
        assertPList(Helper.createPointList(1, 1, 1, 2, 1, 3, 0.4, 0.4), iter.fetchWayGeometry(FetchWayGeometry.PILLAR_AND_ADJ));
        assertPList(Helper.createPointList(0.01, 0.01, 1, 1, 1, 2, 1, 3, 0.4, 0.4), iter.fetchWayGeometry(FetchWayGeometry.ALL));
        ...
        assertTrue(iter.next());
        assertEquals(4, iter.getAdjNode());
        assertPList(Helper.createPointList(1, 9, 1, 8, 1, 7, 1, 6, 1, 5), iter.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY));
        assertPList(Helper.createPointList(0.99, 0.99, 1, 9, 1, 8, 1, 7, 1, 6, 1, 5), iter.fetchWayGeometry(FetchWayGeometry.BASE_AND_PILLAR));
        assertPList(Helper.createPointList(1, 9, 1, 8, 1, 7, 1, 6, 1, 5, 0.4, 0.4), iter.fetchWayGeometry(FetchWayGeometry.PILLAR_AND_ADJ));
        assertPList(Helper.createPointList(0.99, 0.99, 1, 9, 1, 8, 1, 7, 1, 6, 1, 5, 0.4, 0.4), iter.fetchWayGeometry(FetchWayGeometry.ALL));
        assertFalse(iter.next());
    }
    ...
    public void testEnabledElevation() {
        ...
        assertEquals(Helper.createPointList3D(10, 27, 72, 11, 20, 1), GHUtility.getEdge(graph, 0, 1).fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY));
        assertEquals(Helper.createPointList3D(10, 20, -10, 10, 27, 72, 11, 20, 1, 11, 2, 100), GHUtility.getEdge(graph, 0, 1).fetchWayGeometry(FetchWayGeometry.ALL));
        assertEquals(Helper.createPointList3D(11, 2, 100, 11, 20, 1, 10, 27, 72, 10, 20, -10), GHUtility.getEdge(graph, 1, 0).fetchWayGeometry(FetchWayGeometry.ALL));
    }
    ...
    public void testDetachEdge() {
        ...
        assertEquals(2, iter.getAdjNode());
        assertEquals(1, edgeState02.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY).getLatitude(0), 1e-1);
        ...
        assertEquals(3, edgeState20.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY).getLatitude(0), 1e-1);
        ...
        assertEquals(0, iter.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY).size());
        assertEquals(1, edgeState02.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY).getLatitude(0), 1e-1);
        assertEquals(3, edgeState20.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY).getLatitude(0), 1e-1);
