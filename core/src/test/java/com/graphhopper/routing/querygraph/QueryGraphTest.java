...
public class QueryGraphTest {
    ...
    public void testFillVirtualEdges() {
        ...
        assertEquals(4, state.fetchWayGeometry(FetchWayGeometry.ALL).size());

        //  fetch virtual edge and check way geometry
        state = GHUtility.getEdge(queryGraph, 4, 3);
        assertEquals(2, state.fetchWayGeometry(FetchWayGeometry.ALL).size());
    ...
    PointList getPoints(Graph g, int base, int adj) {
        ...
        return edge.fetchWayGeometry(FetchWayGeometry.ALL);
    }
    ...
    public void testWayGeometry_edge() {
        ...
        assertTrue(iter.next());
        assertEquals(0, iter.getAdjNode());
        assertEquals(1, iter.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY).size());
        assertEquals(2, iter.fetchWayGeometry(FetchWayGeometry.BASE_AND_PILLAR).size());
        assertEquals(2, iter.fetchWayGeometry(FetchWayGeometry.PILLAR_AND_ADJ).size());
        assertEquals(3, iter.fetchWayGeometry(FetchWayGeometry.ALL).size());
        assertEquals(Helper.createPointList(0.15, 0.15, 0.1, 0.1, 0.0, 0.0), iter.fetchWayGeometry(FetchWayGeometry.ALL));
        ...
        assertEquals(2, iter.fetchWayGeometry(FetchWayGeometry.PILLAR_AND_ADJ).size());
        assertEquals(3, iter.fetchWayGeometry(FetchWayGeometry.ALL).size());
        assertEquals(Helper.createPointList(0.15, 0.15, 0.2, 0.2, 0.3, 0.3), iter.fetchWayGeometry(FetchWayGeometry.ALL));
    ...
    public void testWayGeometry_pillar() {
        ...
        assertEquals(2, iter.fetchWayGeometry(FetchWayGeometry.PILLAR_AND_ADJ).size());
        assertEquals(3, iter.fetchWayGeometry(FetchWayGeometry.ALL).size());
        assertEquals(Helper.createPointList(0.2, 0.2, 0.1, 0.1, 0.0, 0.0), iter.fetchWayGeometry(FetchWayGeometry.ALL));

        assertTrue(iter.next());
        assertEquals(1, iter.getAdjNode());
        assertEquals(0, iter.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY).size());
        assertEquals(1, iter.fetchWayGeometry(FetchWayGeometry.BASE_AND_PILLAR).size());
        assertEquals(1, iter.fetchWayGeometry(FetchWayGeometry.PILLAR_AND_ADJ).size());
        assertEquals(2, iter.fetchWayGeometry(FetchWayGeometry.ALL).size());
        assertEquals(Helper.createPointList(0.2, 0.2, 0.5, 0.1), iter.fetchWayGeometry(FetchWayGeometry.ALL));
