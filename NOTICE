...
- https://github.com/bmwcarit/hmm-lib, under the Apache License 2.0 (see: hmm-lib module)
- https://github.com/bmwcarit/offline-map-matching, under the Apache License 2.0
  (see: Distributions.java, HmmProbabilities.java and TimeStep.java)
