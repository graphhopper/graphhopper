...
enum class BikeRoadAccess {
    ...
    companion object {
        const val KEY = "bike_road_access"

        @JvmStatic
        fun create(): EnumEncodedValue<BikeRoadAccess> =
            EnumEncodedValue(KEY, BikeRoadAccess::class.java)

        @JvmStatic
        fun find(name: String?): BikeRoadAccess {
