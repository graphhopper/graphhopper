...
public class PtIsochroneResource {
    ...
    public Response doGet(
        ...
        MultiCriteriaLabelSetting router = new MultiCriteriaLabelSetting(graphExplorer, ptEncodedValues, reverseFlow, false, false, false, 0, 1000000, Collections.emptyList());
