...
public class SpatialRuleLookupArrayTest {
    ...
    public void testSmallScenario() {
        ...
        Assert.assertEquals(SpatialRule.Access.CONDITIONAL, spatialRuleLookup.lookupRule(1.2, 1.7).getAccess(null, TransportationMode.MOTOR_VEHICLE, SpatialRule.Access.YES));
