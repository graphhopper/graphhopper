...
public class GraphHopperGtfsTest {
	...
	public void testLoadGtfs() {
		...
		assertEquals("Apparently, the \"speed\" attribute on edges is too imprecise to be used for travel time calculation", 300.0 /* inter-stop travel time according to schedule */, travelTimeSeconds, 0.1);
	}
