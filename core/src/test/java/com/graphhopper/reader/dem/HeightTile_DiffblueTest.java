...
public class HeightTile_DiffblueTest {

  @Rule public ExpectedException thrown = ExpectedException.none();

  /* testedClasses: HeightTile */
  ...
  public void toStringOutputNotNull() {
    ...
    // Arrange
    final HeightTile objectUnderTest = new HeightTile(3, 1, 0, 0, 0.0, 0, 0);

    // Act
    final String retval = objectUnderTest.toString();

    // Assert result
    Assert.assertEquals("3,1", retval);
  }
}
