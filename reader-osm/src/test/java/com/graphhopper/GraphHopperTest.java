...
public class GraphHopperTest {
    ...
    public void simplifyWithInstructionsAndPathDetails() {
        ...
        GHRequest req = new GHRequest()
                ...
                .setProfile(profile)
                .setPathDetails(Arrays.asList("street_name", "street_name_ref", "max_speed"));
        ...
        assertInstruction(instructions.get(0), "", "[0, 4[", 4, 4);
        assertInstruction(instructions.get(1), "", "[4, 16[", 12, 12);
        // via instructions have length = 0, but the point list must not be empty!
        assertInstruction(instructions.get(2), "", "[16, 17[", 0, 1);
        assertInstruction(instructions.get(3), "", "[16, 32[", 16, 16);
        assertInstruction(instructions.get(4), "", "[32, 34[", 2, 2);
        assertInstruction(instructions.get(5), "", "[34, 37[", 3, 3);
        assertInstruction(instructions.get(6), "", "[37, 38[", 1, 1);
        ...
        // check street_names
        List<PathDetail> streetNames = path.getPathDetails().get("street_name_ref");
