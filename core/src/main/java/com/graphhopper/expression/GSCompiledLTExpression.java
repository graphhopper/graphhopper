...
public class GSCompiledLTExpression implements GSCompiledExpression {
    private final String name;
    private final double value;
    private final double parameter;
    private final DecimalEncodedValue encodedValue;

    public GSCompiledLTExpression(String name, DecimalEncodedValue encodedValue, double parameter, double value) {
        this.name = name;
