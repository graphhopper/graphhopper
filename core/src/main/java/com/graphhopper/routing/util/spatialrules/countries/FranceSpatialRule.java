 ...
 * @author Thomas Butz
 */
public class FranceSpatialRule extends DefaultSpatialRule {

    @Override
    public double getMaxSpeed(String highwayTag, double _default) {
        // As defined in: https://wiki.openstreetmap.org/wiki/OSM_tags_for_routing/Maxspeed#France
        switch (highwayTag) {
            case "motorway":
                return 130;
            case "trunk":
    ...
    public Toll getToll(String highwayTag, Toll _default) {
        // https://www.tolls.eu/data/france-prices-map.pdf
