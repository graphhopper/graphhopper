...
public class ShortFastestWeighting extends FastestWeighting {
    ...
    public ShortFastestWeighting(FlagEncoder encoder, ConfigMap cMap) {
        super(encoder);
        timeFactor = checkBounds(TIME_FACTOR, cMap.getDouble(TIME_FACTOR, 1));
        ...
        distanceFactor = checkBounds(DISTANCE_FACTOR, cMap.getDouble(DISTANCE_FACTOR, 0.07));
