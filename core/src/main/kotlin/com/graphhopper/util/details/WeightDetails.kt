...
class WeightDetails(private val weighting: Weighting) : AbstractPathDetailsBuilder(WEIGHT) {
    ...
    public override fun getCurrentValue(): Any? = weight
}
