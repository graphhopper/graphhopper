...
public interface CHGraph extends Graph {
    ...
    int shortcut(int a, int b, int accessFlags, double weight, double distance, long time, int skippedEdge1, int skippedEdge2);

    int shortcutEdgeBased(int a, int b, int accessFlags, double weight, double distance, long time, int skippedEdge1, int skippedEdge2, int origFirst, int origLast);
