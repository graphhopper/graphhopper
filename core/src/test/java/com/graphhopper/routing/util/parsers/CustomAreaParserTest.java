...
public class CustomAreaParserTest {
    ...
    public void setUp() {
        ...
        areaLeft = new CustomArea("left", Collections.singletonList(borderLeft), "area_left");
        ...
        areaRight = new CustomArea("right", Collections.singletonList(borderRight), "area_right");
