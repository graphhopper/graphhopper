...
public class RoutePointAzimuthParser implements IExtensionParser {

	private static final Logger LOG = LoggerFactory
			.getLogger(RoutePointAzimuthParser.class);
	
	public RoutePointAzimuthParser() {
		// TODO Auto-generated constructor stub
	}
	
	public static final String MYID = ExtensionConstants.AZIMUTH;
