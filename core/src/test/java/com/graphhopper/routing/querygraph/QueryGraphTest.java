...
public class QueryGraphTest {
    ...
    void towerSnapWhenCrossingPointIsOnEdgeButCloseToTower() {
        ...
        LocationIndexTree locationIndex = new LocationIndexTree(g, new GHDirectory("", DAType.RAM_NOFILE));
    ...
    public void testVirtualEdgeDistance() {
        ...
        LocationIndexTree index = new LocationIndexTree(g, new GHDirectory("", DAType.RAM_NOFILE));
        index.prepareIndex();
