...
public class RoundTripRoutingTemplateTest {
    ...
    public void lookup_throwsIfNumberOfGivenPointsNotOne() {
        ...
        routingTemplate.lookup(Arrays.asList(ghPoint1, ghPoint2), new FastestWeighting(carFE));
    }
    ...
    public void lookup_throwsIfNumberOfPointsInRequestNotOne() {
        ...
        routingTemplate.lookup(Collections.singletonList(ghPoint1), new FastestWeighting(carFE));
    }
    ...
    public void testLookupAndCalcPaths_simpleSquareGraph() {
        ...
        List<QueryResult> stagePoints = routingTemplate.lookup(ghRequest.getPoints(), weighting);
