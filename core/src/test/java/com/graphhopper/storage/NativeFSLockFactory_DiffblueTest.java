...
public class NativeFSLockFactory_DiffblueTest {

  @Rule public ExpectedException thrown = ExpectedException.none();

  /* testedClasses: NativeFSLockFactory */
  ...
  public void createInputNotNullFalseOutputRuntimeException() {
    ...
    // Arrange
    final NativeFSLockFactory objectUnderTest = new NativeFSLockFactory();
  ...
  @Test
  public void createInputNotNullTrueOutputRuntimeException() {

    // Arrange
    final NativeFSLockFactory objectUnderTest = new NativeFSLockFactory();
    final String fileName = "";
    final boolean writeAccess = true;
