...
public class RealtimeIT {
    ...
    public static void init() {
        ...
        graphHopperFactory = new PtRouterImpl.Factory(ghConfig, new TranslationMap().doImport(), graphHopperGtfs.getBaseGraph(), graphHopperGtfs.getLocationIndex(), graphHopperGtfs.getGtfsStorage());
    }
