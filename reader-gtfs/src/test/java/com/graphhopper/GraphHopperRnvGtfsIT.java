...
public class GraphHopperRnvGtfsIT {
    ...
    public void testRoute1() {
        ...
        assertRouteWeightIs(graphHopper, FROM_LAT, FROM_LON, seconds(15, 0),
                        TO_LAT, TO_LON, seconds(15, 15));
    }
    ...
    public void testRoute2() {
        final double FROM_LAT = 49.4048, FROM_LON = 8.6765; // 116006, HD Hauptbahnhof
        final double TO_LAT = 49.42799, TO_LON = 8.6833; // 113612, Hans-Thoma-Platz
        assertRouteWeightIs(graphHopper, FROM_LAT, FROM_LON, seconds(15, 7),
                        TO_LAT, TO_LON, seconds(15, 21));
    }
