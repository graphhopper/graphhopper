...
import static com.graphhopper.reader.gtfs.GtfsHelper.seconds;
...
public class GraphHopperGtfsIT {
	...
	public void testRoute1() {
		...
		assertRouteWeightIs(graphHopper, FROM_LAT, FROM_LON, TO_LAT, TO_LON, seconds(6, 49));
	}
	...
	public void testRoute2() {
		...
		assertRouteWeightIs(graphHopper, FROM_LAT, FROM_LON, TO_LAT, TO_LON, seconds(6, 19));
	}
	...
	public void testRoute3() {
		...
		final double TO_LAT = 36.914944, TO_LON = -116.761472; // NANAA stop
		assertRouteWeightIs(graphHopper, FROM_LAT, FROM_LON, TO_LAT, TO_LON, seconds(6, 5));
	}
	...
	public void testRoute4() {
		...
		assertRouteWeightIs(graphHopper, FROM_LAT, FROM_LON, TO_LAT, TO_LON, seconds(6, 12));
	}
	...
	public void testRoute5() {
		...
		assertRouteWeightIs(graphHopper, FROM_LAT, FROM_LON, TO_LAT, TO_LON, seconds(8, 10));
	}
	...
	public void testRoute7() {
		...
		assertRouteWeightIs(graphHopper, FROM_LAT, FROM_LON, seconds(10, 1), TO_LAT, TO_LON, seconds(10, 42));
	}
