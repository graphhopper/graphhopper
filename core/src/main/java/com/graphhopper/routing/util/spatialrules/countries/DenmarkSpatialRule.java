 ...
 * @author Thomas Butz
 */
public class DenmarkSpatialRule extends DefaultSpatialRule {
    ...
    public RoadAccess getAccess(String highwayTag, TransportationMode transportationMode, RoadAccess _default) {
        // https://wiki.openstreetmap.org/wiki/OSM_tags_for_routing/Access-Restrictions#Denmark
        if (transportationMode == TransportationMode.MOTOR_VEHICLE
                        && ("track".equals(highwayTag) || "path".equals(highwayTag))) {
