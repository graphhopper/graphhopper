...
public class DefaultReg implements Reg {
    ...
    public RegEntry getRegEntry(String name) {
        if (Roundabout.KEY.equals(name))
            return RegEntry.create(props -> Roundabout.create(),
                    (lookup, props) -> new OSMRoundaboutParser(
                            lookup.getBooleanEncodedValue(Roundabout.KEY))
            );
        else if (GetOffBike.KEY.equals(name))
            return RegEntry.create(props -> GetOffBike.create(),
            ...
            return RegEntry.create(props -> RoadClass.create(),
            ...
            return RegEntry.create(props -> RoadClassLink.create(),
            ...
            return RegEntry.create(props -> RoadEnvironment.create(),
            ...
            return RegEntry.create(props -> RoadAccess.create(),
            ...
            return RegEntry.create(props -> HazmatWater.create(),
            ...
            return RegEntry.create(props -> MaxSlope.create(),
            ...
            return RegEntry.create(props -> RouteNetwork.create(name), null);

        else if (VehicleAccess.key("car").equals(name))
            return RegEntry.create(props -> VehicleAccess.create("car"),
            ...
            return RegEntry.create(props -> VehicleAccess.create("roads"),
                    (lookup, props) -> new RoadsAccessParser(lookup)
            );
        else if (VehicleAccess.key("bike").equals(name))
            return RegEntry.create(props -> VehicleAccess.create("bike"),
            ...
            return RegEntry.create(props -> VehicleAccess.create("racingbike"),
            ...
            return RegEntry.create(props -> VehicleAccess.create("mtb"),
            ...
            return RegEntry.create(props -> VehicleAccess.create("foot"),
            ...
            return RegEntry.create(props -> new DecimalEncodedValueImpl(
        ...
        else if (name.equals(VehiclePriority.key("foot")))
            return RegEntry.create(props -> VehiclePriority.create("foot", 4, PriorityCode.getFactor(1), false),
                    (lookup, props) -> new FootPriorityParser(lookup),
                    RouteNetwork.key("foot")
            );
        else if (name.equals(VehiclePriority.key("bike")))
            return RegEntry.create(props -> VehiclePriority.create("bike", 4, PriorityCode.getFactor(1), false),
                    (lookup, props) -> new BikePriorityParser(lookup),
                    VehicleSpeed.key("bike"), BikeNetwork.KEY
            );
        else if (name.equals(VehiclePriority.key("racingbike")))
            return RegEntry.create(props -> VehiclePriority.create("racingbike", 4, PriorityCode.getFactor(1), false),
                    (lookup, props) -> new RacingBikePriorityParser(lookup),
                    VehicleSpeed.key("racingbike"), BikeNetwork.KEY
            );
        else if (name.equals(VehiclePriority.key("mtb")))
            return RegEntry.create(props -> VehiclePriority.create("mtb", 4, PriorityCode.getFactor(1), false),
