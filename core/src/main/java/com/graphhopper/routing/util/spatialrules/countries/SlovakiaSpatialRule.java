 ...
 * @author Thomas Butz
 */
public class SlovakiaSpatialRule extends DefaultSpatialRule {
    @Override
    ...
    public RoadAccess getAccess(String highwayTag, TransportationMode transportationMode, RoadAccess _default) {
        // https://wiki.openstreetmap.org/wiki/OSM_tags_for_routing/Access-Restrictions#Slovakia
    ...
    public Toll getToll(String highwayTag, Toll _default) {
        // http://www.highwaymaps.eu/slovakia
