...
import static com.graphhopper.example.RoutingExampleTest.out;

public class LowLevelAPIExampleTest {

    String graphLocation = "./target/lowlevel-graph";

    @Test
    public void createAndSaveGraph() {
    ...
    @Test
    public void useContractionHierarchiesToMakeQueriesFaster() {
