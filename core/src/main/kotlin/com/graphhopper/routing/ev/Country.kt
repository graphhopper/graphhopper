...
enum class Country(
    ...
    /**
     * The ISO 3166-1:alpha3 code of this country
     */
    val alpha3: String,
    /**
    ...
    val states: List<State> = subdivisions.asList()

    override fun toString(): String = alpha3 // for background compatibility

    companion object {
        const val KEY = "country"

        private val ALPHA2_MAP: Map<String, Country> =
            entries.filter { it != MISSING }.associateBy { it.alpha2 }

        @JvmStatic
        fun create(): EnumEncodedValue<Country> = EnumEncodedValue(KEY, Country::class.java)

        /**
         * @param iso should be ISO 3166-1 alpha-2
         */
        @JvmStatic
        fun find(iso: String?): Country? = ALPHA2_MAP[iso]
    }
}
