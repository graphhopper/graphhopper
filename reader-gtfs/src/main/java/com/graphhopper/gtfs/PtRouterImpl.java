...
public final class PtRouterImpl implements PtRouter {
    ...
    private class RequestHandler {
        ...
        private List<List<Label.Transition>> findPaths(int startNode, int destNode) {
            ...
            MultiCriteriaLabelSetting stationRouter = new MultiCriteriaLabelSetting(accessEgressGraphExplorer, ptEncodedValues, reverse, false, false, false, 0, maxVisitedNodesForRequest, new ArrayList<>());
            ...
            MultiCriteriaLabelSetting router = new MultiCriteriaLabelSetting(graphExplorer, ptEncodedValues, arriveBy, true, !ignoreTransfers, profileQuery, maxProfileDuration, maxVisitedNodesForRequest, discoveredSolutions);
