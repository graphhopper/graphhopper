...
public class RacingBikeTagParserTest extends AbstractBikeTagParserTester {
    ...
    public void testPriority_avoidanceOfHighMaxSpeed() {
        ...
        assertPriorityAndSpeed(encodingManager, priorityEnc, speedEnc, parsers, 0.8, 24, osmWay);
        ...
        osmWay.setTag("tunnel", "yes");
        assertPriorityAndSpeed(encodingManager, priorityEnc, speedEnc, parsers, 0.4, 18, osmWay);
        ...
        osmWay.setTag("tunnel", "yes");
        osmWay.setTag("maxspeed", "120");
        assertPriorityAndSpeed(encodingManager, priorityEnc, speedEnc, parsers, 0.8, PUSHING_SECTION_SPEED, osmWay);
    ...
    public void testFootwayVsTertiary() {
        ReaderWay osmWay = new ReaderWay(1);
        osmWay.setTag("highway", "tertiary");
        assertPriorityAndSpeed(1.2, 24.0, osmWay);

        // TODO NOW probably less prio would be better for racing bike if shared with foot
        osmWay = new ReaderWay(1);
