...
public class MapboxResponseConverterTest {
    ...
    public void voiceInstructionsTest() {
        ...
        // {"intersections":[{"entry":[],"bearings":[],"location":[1.519929,42.530661]}],"driving_side":"right","geometry":"guzbpAorw{AtGpHxGtBdLkAbHiGfDkIhAkKIgG}@{GmBwF{EkGtIaP`]k[`j@ws@|b@ouA`qCeiOt`EiaW|eGucR","mode":"driving","maneuver":{"bearing_after":0,"bearing_before":0,"location":[1.519929,42.530661],"modifier":"straight","type":"roundabout","exit":3,"instruction":"At roundabout, take exit 3"},"weight":3256.9,"duration":180.4,"name":"","distance":3256.9,"voiceInstructions":[{"distanceAlongGeometry":2000.0,"announcement":"In 2 kilometers keep right","ssmlAnnouncement":"<speak><amazon:effect name=\"drc\"><prosody rate=\"1.08\">In 2 kilometers keep right</prosody></amazon:effect></speak>"},{"distanceAlongGeometry":1000.0,"announcement":"In 1 kilometer keep right","ssmlAnnouncement":"<speak><amazon:effect name=\"drc\"><prosody rate=\"1.08\">In 1 kilometer keep right</prosody></amazon:effect></speak>"},{"distanceAlongGeometry":400.0,"announcement":"In 400 meters keep right","ssmlAnnouncement":"<speak><amazon:effect name=\"drc\"><prosody rate=\"1.08\">In 400 meters keep right</prosody></amazon:effect></speak>"},{"distanceAlongGeometry":80.0,"announcement":"keep right","ssmlAnnouncement":"<speak><amazon:effect name=\"drc\"><prosody rate=\"1.08\">keep right</prosody></amazon:effect></speak>"}],"bannerInstructions":[{"distanceAlongGeometry":3256.9,"primary":{"text":"keep right","components":[{"text":"keep right","type":"text"}],"type":"turn","modifier":"slight right"},"secondary":null}]}
