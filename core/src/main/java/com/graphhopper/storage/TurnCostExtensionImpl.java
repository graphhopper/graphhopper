 ...
 * @author Peter Karich
 */
public class TurnCostExtensionImpl implements TurnCostExtension {
    ...
    public TurnCostExtensionImpl(NodeAccess nodeAccess, DataAccess turnCosts) {
        this.nodeAccess = nodeAccess;
        this.turnCosts = turnCosts;
    }

    public TurnCostExtensionImpl(TurnCostExtensionImpl turnCostExtension) {
