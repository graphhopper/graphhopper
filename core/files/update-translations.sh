...
translations="en_US SKIP ar ast bg ca cs_CZ da_DK de_DE el es fa fil fi fr_FR fr_CH gl he hr_HR hsb hu_HU it ja lt_LT ne nl pl_PL pt_BR pt_PT ro ru si sk sv_SE tr uk vi_VI zh_CN"
file=$1
