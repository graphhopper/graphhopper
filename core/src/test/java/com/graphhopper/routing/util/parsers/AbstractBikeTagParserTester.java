...
public abstract class AbstractBikeTagParserTester {
    ...
    protected void assertPriority(PriorityCode expectedPrio, ReaderWay way) {
        ...
        ArrayEdgeIntAccess intAccess = new ArrayEdgeIntAccess(encodingManager.getBytesForFlags() / 4 + 1);
        int edgeId = 0;
    ...
    public void testTramStations() {
        ...
        intAccess = new ArrayEdgeIntAccess(encodingManager.getBytesForFlags() / 4 + 1);
