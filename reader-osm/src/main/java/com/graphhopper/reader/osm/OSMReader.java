...
public class OSMReader implements DataReader, TurnCostParser.ExternalInternalMap {
    ...
    void process(File osmFile, Consumer<Entity> consumer) {
        try {
            OpenStreetMap
                    .entityStream(osmFile.toPath(), false, true)
                    .forEach(entity -> consumer.accept(entity));
    ...
    void preProcess(File osmFile) {
        ...
        process(osmFile, new DefaultEntityHandler() {
            @Override
