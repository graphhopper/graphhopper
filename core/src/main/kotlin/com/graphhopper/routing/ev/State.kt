 ...
 *
 * @param stateCode should be ISO 3166-2 but with hyphen like US-CA
 */
enum class State(
    /**
     * The ISO 3166-2 code with hyphen. E.g. US-CA
     */
    ...
    override fun toString(): String = stateCode

    companion object {
        const val KEY = "state"
        const val ISO_3166_2 = "ISO3166-2"

        private val STATE_BY_CODE: Map<String, State> =
            java.util.Map.copyOf(entries.associateBy { it.stateCode }) // unmodifiable

        /**
         * @param iso should be ISO 3166-2 but with hyphen like US-CA
         */
        @JvmStatic
        fun find(iso: String?): State = STATE_BY_CODE[iso] ?: MISSING

        @JvmStatic
        fun create(): EnumEncodedValue<State> = EnumEncodedValue(KEY, State::class.java)
    }
}
