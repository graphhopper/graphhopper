...
public class SpatialRuleLookupArrayTest {
    ...
    public void testSmallScenario() {
        ...
        assertEquals(AccessValue.EVENTUALLY_ACCESSIBLE, spatialRuleLookup.lookupRule(1.2, 1.7).isAccessible(null, "", AccessValue.ACCESSIBLE));
        assertEquals(AccessValue.EVENTUALLY_ACCESSIBLE, spatialRuleLookup.lookupRule(1.2, 3.7).isAccessible(null, "", AccessValue.ACCESSIBLE));
        // Not in the second Polygon anymore, but due to the resolution of 1, this should be still match the rule
        assertEquals(AccessValue.EVENTUALLY_ACCESSIBLE, spatialRuleLookup.lookupRule(3.9, 3.7).isAccessible(null, "", AccessValue.ACCESSIBLE));
        assertEquals(AccessValue.ACCESSIBLE, spatialRuleLookup.lookupRule(2.2, 1.7).isAccessible(null, "", AccessValue.ACCESSIBLE));
    ...
    public void testExact() {
        ...
        assertEquals(AccessValue.ACCESSIBLE, spatialRuleLookup.lookupRule(3.9, 3.7).isAccessible(null, "", AccessValue.ACCESSIBLE));
        assertEquals(AccessValue.ACCESSIBLE, spatialRuleLookup.lookupRule(2.2, 1.7).isAccessible(null, "", AccessValue.ACCESSIBLE));
    ...
    public void testExactAdjacentBorder() {
        ...
        assertEquals("bot", spatialRuleLookup.lookupRule(1.6, 1.5).getUniqueName());
    }
