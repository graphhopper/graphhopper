...
public class GraphHopperStorageWithTurnCostsTest extends GraphHopperStorageTest
{
    ...
    public void testSave_and_fileFormat_withTurnCostEntries() throws IOException
    {
        ...
        assertEquals(1337, turnCostStorage.getTurnCostsFlags(0, iter1.getEdge(), iter2.getEdge()));
        assertEquals(666, turnCostStorage.getTurnCostsFlags(0, iter2.getEdge(), iter1.getEdge()));
        assertEquals(815, turnCostStorage.getTurnCostsFlags(1, iter1.getEdge(), iter2.getEdge()));
        assertEquals(0, turnCostStorage.getTurnCostsFlags(3, iter1.getEdge(), iter2.getEdge()));
