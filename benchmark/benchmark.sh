...
"graph.flag_encoders=car|turn_costs=true" \
"graph.encoded_values=road_class,road_class_link,road_environment,max_speed,road_access,surface,smoothness,max_width,max_height,max_weight,max_axle_load,max_length,hazmat,hazmat_tunnel,hazmat_water,toll,track_type,mtb_rating,hiking_rating,horse_rating,lanes" \
