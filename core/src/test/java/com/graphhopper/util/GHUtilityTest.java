...
public class GHUtilityTest {
    ...
    double getLengthOfAllEdges(Graph graph) {
        ...
        while (iter.next()) {
            ...
            distance += iter.fetchWayGeometry(FetchWayGeometry.ALL).calcDistance(calc);
        }
        return distance;
    }
    ...
    public void testCopy() {
        ...
        assertEquals(Helper.createPointList(-1, 3, 12, 10), edgeState.fetchWayGeometry(FetchWayGeometry.PILLAR_ONLY));
