...
public class DistancePlaneProjection_DiffblueTest {

  @Rule public ExpectedException thrown = ExpectedException.none();

  /* testedClasses: DistancePlaneProjection */
  ...
  public void toStringOutputNotNull() {
    ...
    // Arrange
    final DistancePlaneProjection objectUnderTest = new DistancePlaneProjection();

    // Act
    final String retval = objectUnderTest.toString();

    // Assert result
    Assert.assertEquals("PLANE_PROJ", retval);
  }
}
