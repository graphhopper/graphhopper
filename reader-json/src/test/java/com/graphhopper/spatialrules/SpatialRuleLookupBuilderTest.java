...
public class SpatialRuleLookupBuilderTest {
    ...
    public void testIndex() throws FileNotFoundException {
        ...
        // Berlin
        Assert.assertEquals(SpatialRule.Access.CONDITIONAL, spatialRuleLookup.lookupRule(52.5243700, 13.4105300).getAccess("track", TransportationMode.MOTOR_VEHICLE, SpatialRule.Access.YES));
