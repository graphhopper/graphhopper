...
public class GenericWeightingTest {
    ...
    public void setUp() {
        ...
        graph.getEdgeIteratorState(0, 1).setFlags(em.handleWayTags(way, 1, 0));
    }
    ...
    public void testDisabledRoadAttributes() {
        ...
        simpleGraph.getEdgeIteratorState(0, 1).setFlags(simpleEncodingManager.handleWayTags(way, 1, 0));
