...
/**
 * Defines the default rules for roads in Great Britain
 *
 * @author Robin Boldt
 */
public class GreatBritainSpatialRule extends DefaultSpatialRule {
    ...
    public AccessValue getAccessValue(String highwayTag, TransportationMode transportationMode, AccessValue _default) {
        if (transportationMode == TransportationMode.BICYCLE || transportationMode == TransportationMode.FOOT) {
            if (highwayTag.equals("bridleway"))
