...
public class SpatialRuleLookupJTSTest {
    ...
    public void testSpatialLookup() {
        ...
        SpatialRule germany = new DefaultSpatialRule(Collections.singletonList(deBorder)) {
            @Override
            public String getId() {
                return "DEU";
            }
        ...
        SpatialRule austria = new DefaultSpatialRule(Collections.singletonList(atBorder)) {
            @Override
            public String getId() {
                return "AUT";
            }
    ...
    public void testPrecision() {
        ...
        List<Polygon> borders = Collections.singletonList(germanPolygon);
        spatialRules.add(new DefaultSpatialRule(borders) {
            @Override
            public String getId() {
                return "DEU";
            }
