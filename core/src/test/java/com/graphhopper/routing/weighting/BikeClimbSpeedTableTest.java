...
public class BikeClimbSpeedTableTest {
    ...
    public void testSpeed() {
        ...
        assertEquals(18, table.speed(0), 0.01);
        // aero resistance dominates for small slopes
        assertEquals(12.85, table.speed(2), 0.01);
        assertEquals(7.77, table.speed(5), 0.01);
        assertEquals(3.66, table.speed(12), 0.01);
        // blending into the walking speed of the pushing cyclist
        assertEquals(2.29, table.speed(15), 0.01);
        assertEquals(2.0, table.speed(20), 0.01);
        assertThrows(IllegalArgumentException.class, () -> table.speed(-1));
    ...
    public void testSlopeOffset() {
        ...
        // a slightly reduced speed is interpreted as an increased rolling resistance ...
        assertEquals(0.36, table.getSlopeOffset(17), 0.01);
        // ... but the increase is capped at 0.012 which is already reached for 14.4km/h
