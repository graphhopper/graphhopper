...
//        System.out.println(tmp.getPoints());
    ...
    public void testCalcAverageSpeedDetails() {
        ...
        Map<String, List<PathDetail>> details = p.calcDetails(Arrays.asList(AVERAGE_SPEED), new PathDetailsBuilderFactory(), 0);
    ...
    public void testCalcStreetNameDetails() {
        ...
        Map<String, List<PathDetail>> details = p.calcDetails(Arrays.asList(STREET_NAME), new PathDetailsBuilderFactory(), 0);
        assertTrue(details.size() == 1);
    ...
    public void testCalcEdgeIdDetails() {
        ...
        Map<String, List<PathDetail>> details = p.calcDetails(Arrays.asList(EDGE_ID), new PathDetailsBuilderFactory(), 0);
        assertTrue(details.size() == 1);
    ...
    public void testCalcTimeDetails() {
        ...
        Map<String, List<PathDetail>> details = p.calcDetails(Arrays.asList(TIME), new PathDetailsBuilderFactory(), 0);
        assertTrue(details.size() == 1);
    ...
    public void testCalcDistanceDetails() {
        ...
        Map<String, List<PathDetail>> details = p.calcDetails(Arrays.asList(DISTANCE), new PathDetailsBuilderFactory(), 0);
        assertTrue(details.size() == 1);
